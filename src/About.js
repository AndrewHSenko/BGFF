import About_Pic_One from "./Assets/About.png";
        ...
        <div class="row mx-md-4 mx-1 my-2">
            <div class="col-12 col-lg-6 text-center p-3">
                ...
                <div class="d-flex justify-content-center d-lg-none ">
                    <img src={About_Pic_One} class="w-75 my-auto mb-3 p-2 rounded-5 bg-warning-subtle" alt="The Buy Gum Free Fun Team" />
                </div>
            ...
            <div class="col-12 col-lg-6 d-lg-flex justify-content-center align-content-center d-none">
                <img src={About_Pic_One} class="w-75 my-auto p-2 rounded-5 bg-warning-subtle" alt="The Buy Gum Free Fun Team" />
